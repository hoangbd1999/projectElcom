...
public class KafkaConsumerConfig {
    ...
    @Value("${kafka.bootstrap.servers.vsat}")
...
//        props.put(ConsumerConfig.GROUP_ID_CONFIG, kafkaConsumerGroupId);
        ...
        //props.put(ConsumerConfig.AUTO_COMMIT_INTERVAL_MS_CONFIG, 100); // default is 5000 (5 seconds)
        ...
        /*
            ...
            calls to poll() was longer than the configured max.poll.interval.ms, which typically implies that the poll loop is spending too much time message processing.
