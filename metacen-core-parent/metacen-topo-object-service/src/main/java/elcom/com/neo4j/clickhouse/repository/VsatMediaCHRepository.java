...
//            }
    ...
    public List<VsatMedia> searchUUid(String uuid) {
        VsatMediaPagingDTO recognitionPlatePagingDTO = new VsatMediaPagingDTO();
        List<VsatMedia> lstMediaRaw = new ArrayList<>();
        Session session = null;
        long count = 0;
        try {
            ...
            String sql = "SELECT  "
                    ...
                    + " FROM vsat_media_data_analyzed WHERE 1=1 ";

            sql += " AND uuidKey ='"+uuid+"' or vsatMediaUuidKey ='" + uuid + "' " ;
...
//            }
    ...
    public List<VsatMedia> searchProcess(String uuid) {
        VsatMediaPagingDTO recognitionPlatePagingDTO = new VsatMediaPagingDTO();
        List<VsatMedia> lstMediaRaw = new ArrayList<>();
        Session session = null;
        long count = 0;
        try {
            ...
            String sql = "SELECT  "
                    + "ingestTime"
                    + " FROM data_process_status WHERE 1=1 ";

            sql += " AND recordId ='"+uuid+"'" ;
...
//            }
            ...
            query.addScalar("ingestTime", TimestampType.INSTANCE)
                    .setResultTransformer(Transformers.aliasToBean(VsatMedia.class));
