 ...
 */
package com.elcom.metacen.contact.constant;
...
public class Constant {
    ...
    public static final String REDIS_TILEMAPS_LST_KEY = "METACEN_TILEMAPS_LST";
    public static final int REDIS_TILEMAPS_LST_FETCH_MAX = 10000;
