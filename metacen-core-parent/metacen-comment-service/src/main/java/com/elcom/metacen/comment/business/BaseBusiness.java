...
import com.elcom.metacen.comment.messaging.rabbitmq.RabbitMQClient;
import com.elcom.metacen.comment.messaging.rabbitmq.RabbitMQProperties;
import com.elcom.metacen.comment.model.dto.ABACResponseDTO;
import com.elcom.metacen.comment.model.dto.AuthorizationResponseDTO;
import com.elcom.metacen.comment.model.dto.RoleMenuDTO;
...
public class BaseBusiness {
    ...
    public ResponseMessage noteChange(Map<String, Object> bodyParam) {
        ...
        commentRpcRequest.setRequestPath(RabbitMQProperties.ENRICH_DATA_RPC_INTERNAL);
        ...
        String result = rabbitMQClient.callRpcService(RabbitMQProperties.ENRICH_DATA_RPC_EXCHANGE,
                RabbitMQProperties.ENRICH_DATA_RPC_QUEUE, RabbitMQProperties.ENRICH_DATA_RPC_KEY, commentRpcRequest.toJsonString());
        LOGGER.info("comment - result: " + result);
        if (result != null) {
