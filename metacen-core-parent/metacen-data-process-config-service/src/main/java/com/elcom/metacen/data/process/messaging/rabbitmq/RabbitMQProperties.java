...
public class RabbitMQProperties {
    ...
    @Value("${contact.check-exist-object-group.url}")
    public static String CONTACT_CHECK_EXIST_OBJECT_GROUP_URL;
    ...
    public RabbitMQProperties(@Value("${user.rpc.exchange}") String userRpcExchange,
            ...
            @Value("${contact.check-exist-object-group.url}") String contactCheckExistObjectGroupUrl
    ) {
        //USER
        ...
        CONTACT_CHECK_EXIST_OBJECT_GROUP_URL = contactCheckExistObjectGroupUrl;
    }
}
