...
@Getter
@Setter
@Table(name = "satellite_image_data_analyzed")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "SatelliteImageDataAnalyzed.findAll", query = "SELECT sida FROM SatelliteImageDataAnalyzed sida")})
public class SatelliteImageDataAnalyzed implements Serializable {
    ...
    public SatelliteImageDataAnalyzed() {
    }

    public SatelliteImageDataAnalyzed(String uuidKey) {
