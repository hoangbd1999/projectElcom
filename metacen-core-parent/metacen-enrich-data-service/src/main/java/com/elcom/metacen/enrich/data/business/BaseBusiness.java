...
import com.elcom.metacen.enrich.data.messaging.rabbitmq.RabbitMQClient;
import com.elcom.metacen.enrich.data.messaging.rabbitmq.RabbitMQProperties;
import com.elcom.metacen.enrich.data.model.dto.ABACResponseDTO;
import com.elcom.metacen.enrich.data.model.dto.AuthorizationResponseDTO;
import com.elcom.metacen.enrich.data.model.dto.CommentDTO;
import com.elcom.metacen.enrich.data.model.dto.RoleMenuDTO;
...
public class BaseBusiness {
    ...
    public ABACResponseDTO authorizeABAC(String requestMethod, String userUuid, String apiPath) {
    ...
    public void callLinkObject( Map<String, Object> body) {
        RequestMessage abacRpcRequest = new RequestMessage();
        abacRpcRequest.setBodyParam(body);
        rabbitMQClient.callWorkerService(RabbitMQProperties.LINK_OBJECT_URL, abacRpcRequest.toJsonString());
    }
