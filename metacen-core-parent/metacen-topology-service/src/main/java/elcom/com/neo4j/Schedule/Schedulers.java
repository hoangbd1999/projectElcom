...
//            config.setString("taskmanager.memory.network.min","50MB");
            config.setString("taskmanager.memory.network.max","3GB");
            config.setString("taskmanager.heap.size","3GB");
            config.setString("execution.target","local");
            config.setString("taskmanager.memory.network.fraction","4.4");
            config.setString("execution.attached","true");
            ExecutionEnvironment env =   new ExecutionEnvironment(new DefaultExecutorServiceLoader(),config,null);
